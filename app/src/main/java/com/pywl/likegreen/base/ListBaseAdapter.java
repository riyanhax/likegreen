...
public abstract class ListBaseAdapter<T> extends RecyclerView.Adapter<SuperViewHolder> {
    ...
    public static final int NOT_NET_TYPE = 1; //没有网络
    public static final int LOAD_FAIL_TYPE = 2; //加载失败
    public static final int NET_ERR_TYPE = 3; //网络异常
    public static final int DEFAULT_TYPE = 4; //默认
