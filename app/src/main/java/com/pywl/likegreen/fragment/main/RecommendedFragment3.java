...
public class RecommendedFragment3 extends Fragment implements View.OnClickListener {
...
/*    private View mIvRecommendShare;
    ...
    private void startCurVideoView(RecyclerView recyclerView) {
        ...
        if (visibleItemPosition >= 0 && mCurrentPosition != visibleItemPosition) {
            ...
            ShortVideoAdapter.ViewHolder holderView = (ShortVideoAdapter.ViewHolder) recyclerView.findViewHolderForLayoutPosition(mCurrentPosition);
            if (holderView != null) {
                mShortVideoListAdapter.setCurViewHolder(holderView);
    ...
    private RecyclerView.OnScrollListener mOnScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                startCurVideoView(recyclerView);
            }
        }
