...
/*主播之前设置
* */
public class SetAnchorActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private boolean checkPublishPermission() {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (PackageManager.PERMISSION_GRANTED != ActivityCompat.checkSelfPermission(SetAnchorActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                permissions.add(Manifest.permission.WRITE_EXTERNAL_STORAGE);
            }
            if (PackageManager.PERMISSION_GRANTED != ActivityCompat.checkSelfPermission(SetAnchorActivity.this, Manifest.permission.CAMERA)) {
                permissions.add(Manifest.permission.CAMERA);
            }
            if (PackageManager.PERMISSION_GRANTED != ActivityCompat.checkSelfPermission(SetAnchorActivity.this, Manifest.permission.RECORD_AUDIO)) {
                permissions.add(Manifest.permission.RECORD_AUDIO);
            }
            if (PackageManager.PERMISSION_GRANTED != ActivityCompat.checkSelfPermission(SetAnchorActivity.this, Manifest.permission.READ_PHONE_STATE)) {
                permissions.add(Manifest.permission.READ_PHONE_STATE);
            }
            if (permissions.size() != 0) {
                ActivityCompat.requestPermissions(SetAnchorActivity.this,
    ...
    private SetAnchorActivity.MsgReceiver msgReceiver = null;
...
//                    qosGroup.setVisibility(View.VISIBLE);
            ...
            case R.id.main_start:
                ...
                {
                    Intent intent = new Intent(SetAnchorActivity.this, LiveStreamingActivity.class);
           ...
           /* case R.id.main_scan_image:
                Intent intent = new Intent(SetAnchorActivity.this, QRCodeScanActivity.class);
